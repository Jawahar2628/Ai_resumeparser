  ...
  return (
    <div className="bg-[#030514] text-slate-100 min-h-screen p-6 rounded-2xl space-y-6 font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {stats.map((stat, i) => (
          <div key={i} className="bg-[#030514] p-4 rounded-xl border border-slate-800 shadow-sm space-y-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-[#030514] p-6 rounded-2xl border border-slate-800 shadow-sm space-y-4">
          <h3 className="text-xs font-bold text-slate-100">Resume Source</h3>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="relative w-40 h-40 flex items-center justify-center">
              ...
              <div className="absolute flex flex-col items-center justify-center text-center">
                <span className="text-sm font-bold text-slate-100">2,453</span>
        ...
        <div className="lg:col-span-2 bg-[#030514] p-6 rounded-2xl border border-slate-800 shadow-sm space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-xs font-bold text-slate-100">Pipeline Trend</h3>
            <div className="flex items-center gap-4 text-[11px] font-semibold">
              <span className="flex items-center gap-1 text-blue-400"><span className="w-2.5 h-0.5 bg-blue-500 inline-block"></span> Resumes</span>
              <span className="flex items-center gap-1 text-emerald-400"><span className="w-2.5 h-0.5 bg-emerald-500 inline-block"></span> Shortlisted</span>
              <span className="flex items-center gap-1 text-amber-400"><span className="w-2.5 h-0.5 bg-amber-500 inline-block"></span> Interviewed</span>
              <span className="flex items-center gap-1 text-purple-400"><span className="w-2.5 h-0.5 bg-purple-500 inline-block"></span> Offers</span>
            </div>
          </div>
          ...
          <div className="h-48 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={pipelineTrendData}>
                ...
                <Tooltip contentStyle={{ backgroundColor: '#030514', borderColor: '#334155', borderRadius: '8px' }} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#030514] p-6 rounded-2xl border border-slate-800 shadow-sm space-y-4">
          <h3 className="text-xs font-bold text-slate-100">Top Skills in Demand</h3>
            ...
            {topSkills.map((item, idx) => (
              <div key={idx} className="space-y-1">
                ...
                <div className="w-full h-1.5 bg-slate-800 rounded-full overflow-hidden">
                  <div className={`h-full bg-blue-600 rounded-full ${item.width}`}></div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-[#030514] p-6 rounded-2xl border border-slate-800 shadow-sm space-y-4">
          <h3 className="text-xs font-bold text-slate-100">Experience Wise Distribution</h3>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            {/* Donut Chart */}
        ...
        <div className="bg-[#030514] p-6 rounded-2xl border border-slate-800 shadow-sm flex flex-col justify-between items-center text-center space-y-4">
          <h3 className="text-xs font-bold text-slate-100">Interview Success Rate</h3>
          ...
          <div className="relative w-28 h-28 flex items-center justify-center">
            ...
            <div className="absolute flex flex-col items-center justify-center">
              <span className="text-lg font-black text-slate-100">70%</span>
            </div>
          </div>

          <span className="text-xs font-bold text-slate-300">Success Rate</span>
        </div>
      </div>
    </div>
  );
