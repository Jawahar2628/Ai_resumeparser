  ...
  return (
    <aside className="w-64 glass border-r border-slate-800 flex flex-col h-full bg-slate-900/40">
      ...
      <div className="p-4 border-t border-slate-800 space-y-1">
        <NavLink to="/settings" className={({ isActive }) => `flex items-center gap-3 px-4 py-2.5 rounded-xl transition-colors cursor-pointer ${isActive ? "bg-indigo-500/20 text-indigo-400 border border-indigo-500/30" : "text-slate-400 hover:text-slate-200 hover:bg-slate-800/50"}`}>
          <Settings size={20} />
